...
export function BookListItem({ googleId, title, authors, description, thumbnail, href, date, clickEvent, saved, screenWidth }) {
  console.log(saved);
  return (
        ...
        <div className="float-right">
          {!saved ? (
            <button 
              ...
              onClick={(event) => 
              clickEvent(event, googleId, title, authors, description, href, thumbnail)}>
              Save
            </button>
          ) : (
            <button 
