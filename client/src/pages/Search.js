...
class Search extends Component {
  ...
  handleSave = (e, googleId, title, authors, description, href, thumbnail) => {
    e.preventDefault();
    API.saveBook({ googleId, title, authors, description, href, thumbnail }).then((res) => this.loadSavedBooks());
  };
      ...
      <Container>
          ...
          <div className="col rounded bg-light mb-4 mt-4 p-4">
            ...
            <form>
              <div className="form-group">
                ...
                <input type="text" className="form-control" id="bookSearch" name="bookSearch" value={this.state.bookSearch} onChange={this.handleInputChange} />
              </div>
        ...
        <Row>
          <div className="col border border-rounded p-3 mb-4">
            {this.state.searched === "" ? <h4>Results</h4> : <h4>Results for {this.state.searched}</h4>}
                ...
                {this.state.books.map((book) => {
                  return (
                    <BookListItem
                      ...
                      clickEvent={this.checkIfSaved(book.id) ? this.deleteSavedBook : this.handleSave}
